...
def evaluate(gold, predictions, classes):
    ...
    for true_labels, predicted_labels in zip(gold, predictions):
        ...
        #print(classes)
        #print(predicted_labels_onehot)
        #print(predicted_labels)
        #print(true_labels)
        #print(true_labels_onehot)
...
def read_and_evaluate(prediction_file, gold_file, classes_file_coarse, classes_file_fine):
    ...
    #f1_c, f1_sd_c = evaluate(y_true_coarse, y_pred_coarse, classes_fine)
    #f1_f, f1_sd_f = evaluate(y_true_fine, y_pred_fine, classes_coarse)
